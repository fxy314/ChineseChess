...
void Board::paintEvent(QPaintEvent *)
{
    ...
    QPainter p(this);
    p.fillRect(this->rect(),QColor(255,199,142));
...
void Board::drawStone(QPainter &p, int id)
{
    ...
    if(id==_selectid){
        ...
        p.setBrush(QBrush(QColor(227,159,15)));
    }
    p.setPen(Qt::black);
    QRect rect=QRect( c.x()-_r, c.y()-_r, _r*2, _r*2);
    p.drawEllipse(center(id),_r,_r);
    if(id<16){
        p.setPen(Qt::red);
    }
    p.setFont(QFont("system",_r*30,_r*30));
    p.drawText(rect,_s[id].name(),QTextOption(Qt::AlignCenter));
...
//    else p.setBrush(QColor(227,159,15));

//    p.drawEllipse(center(id),_r,_r);
//    QPoint c=center(id);
//    QRect rect=QRect( c.x()-_r, c.y()-_r, _r*2, _r*2);
//    p.setFont(QFont("system", _r*200, _r*200));
//    p.drawText(rect, name(id), QTextOption(Qt::AlignCenter));
}
